...
const SAMPLE_TOKENS = [
  { tokenid: 1, tokenno: "P-0001", appprocessid: 300, applicantName: "Muhammad Ali" },
  { tokenid: 2, tokenno: "P-0002", appprocessid: 301, applicantName: "Ahmed Khan" },
  { tokenid: 3, tokenno: "P-0003", appprocessid: 302, applicantName: "Sara Bibi" },
]

const QUESTIONNAIRES = [
  { id: 1, name: "Physical Test - Driving", points: 30 },
  { id: 2, name: "Physical Test - Road Signs", points: 20 },
  { id: 3, name: "Physical Test - Practical", points: 30 },
]
...
export default function PhysicalTestPage() {
  ...
  const simulateResult = useCallback(() => {
    const total = 30
    const right = Math.floor(Math.random() * 20) + 6
          ...
          <div className="p-4">
            {activeSubTab === "appraisal" && (
              <div className="flex flex-col items-center justify-center gap-3 py-10 text-center text-muted-foreground">
                <p className="text-sm">Select a questionnaire and call a token to start the physical test.</p>
                <Button size="sm" variant="outline" onClick={simulateResult}>
                  Simulate Physical Test
                </Button>
              </div>
            )}
